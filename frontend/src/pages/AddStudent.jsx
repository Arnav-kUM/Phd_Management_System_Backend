  ...
  return (
    <div>
      <div className="flex justify-end items-center">
        ...
        <label
          htmlFor="csv-upload"
          className="inline-block px-4 py-2 m-3 text-sm font-bold text-white bg-pantone-blue rounded-xl cursor-pointer hover:bg-pantone-dark-blue focus:bg-pantone-dark-blue ml-4"
        >
          Upload with CSV
        </label>
        <input
